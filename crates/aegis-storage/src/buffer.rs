...
mod tests {
    ...
    fn test_buffer_pool_new_page() {
        ...
        let handle = pool
            .new_page(PageId(1), PageType::Data)
    ...
    fn test_buffer_pool_fetch_page() {
        ...
        pool.new_page(PageId(1), PageType::Data)
            .expect("new_page should succeed");
    ...
    fn test_buffer_pool_eviction() {
        ...
        let _h2 = pool
            .new_page(PageId(2), PageType::Data)
            .expect("new_page 2 should succeed");
        let _h3 = pool
            .new_page(PageId(3), PageType::Data)
            .expect("new_page 3 should succeed");
        ...
        let _h4 = pool
            .new_page(PageId(4), PageType::Data)
            .expect("new_page 4 after eviction should succeed");
