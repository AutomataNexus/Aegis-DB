...
AegisDB v0.2.5 includes production-ready security features:
...
AegisDB v0.2.5 supports 6-level data classification for columns and fields, enabling fine-grained access control and compliance enforcement for PHI, PII, and other sensitive data categories.
...
AegisDB v0.2.5 enforces query safety limits to prevent accidental resource exhaustion and protect against runaway queries.
...
**Document Version:** 2.0.0 (Aegis-DB v0.2.5)
