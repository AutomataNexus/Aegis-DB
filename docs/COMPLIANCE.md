...
Aegis-DB v0.2.5 provides built-in compliance features to help organizations meet regulatory requirements. **634 tests** validate compliance functionality across the workspace.
...
Aegis-DB v0.2.5 introduces column-level data classification to identify and protect sensitive data, including Protected Health Information (PHI) and Personally Identifiable Information (PII).
